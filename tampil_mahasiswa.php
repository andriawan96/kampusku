<?php
    //periksa apakah user sudah login, sek kehadiran session name
    ...
    if(isset($_GET["submit"])){
      ...
      //filter untuk $nama dalam mencegah sql injection
...
<div id="header">
  ...
  <div id="footer">
      Copyright © <?php echo date("Y"); ?> DuniaIlkom x Andriawan
  </div>
  </body>
</html>